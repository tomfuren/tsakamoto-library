...
<script setup>
    ...
    const validatePassword = (blur) => {
        ...
        if(password.length < minLength){
            ...
            if (blur) errors.value.password = 'Password must contein at least one uppercase letter.'
        } else if (!hasLowercase) {
            if (blur) errors.value.password = 'Password must contein at least one lowercase letter.'
        } else if (!hasNumber) {
            if (blur) errors.value.password = 'Password must contein at least one number.'
        } else if (!hasSpecialChar) {
            if (blur) errors.value.password = 'Password must contein at least one special character.'
        } else {
    ...
    const validateResident = (blur) => {
        if (!formData.value.isAustralian) {
            if (blur) errors.value.resident = "Please confirm your residency status.";
        } else {

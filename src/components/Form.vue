            ...
            <div class="col-md-8 offset-md-2">
                ...
                <form @submit.prevent="submitForm">
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            <div class="form-check">
                                ...
                                id="isAustralian"
                                    v-model="formData.isAustralian" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="reason" rows="3" v-model="formData.reason" required minlength="10" maxlength="200"></textarea>
                    </div>
